...
public class Training {
	...
	public static void main(String[] args) throws Exception {
		...
		b.add(AnalysisEngineFactory.createEngineDescription(PrepareClearTk.class, PrepareClearTk.PARAM_VIEW_NAME,
				...
				PrepareClearTk.PARAM_SUBANNOTATIONS, Arrays.asList(Figure.class.getName())), CAS.NAME_DEFAULT_SOFA,
				tmpView);
		...
		b.add(AnalysisEngineFactory.createEngineDescription(ClearTkGenderAnnotator.class,
				DefaultDataWriterFactory.PARAM_DATA_WRITER_CLASS_NAME, WekaStringOutcomeDataWriter.class,
