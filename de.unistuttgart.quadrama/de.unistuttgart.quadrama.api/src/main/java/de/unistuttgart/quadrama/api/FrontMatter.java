 ...
 * @generated */
public class FrontMatter extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(FrontMatter.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected FrontMatter() {/* intentionally empty block */}
   ...
   */
  public FrontMatter(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public FrontMatter(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
