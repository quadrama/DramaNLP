 ...
 * @generated */
public class SpeakerFigure extends Figure {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SpeakerFigure.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SpeakerFigure() {/* intentionally empty block */}
   ...
   */
  public SpeakerFigure(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
   ...
   */
  public SpeakerFigure(JCas jcas) {
    super(jcas);
    readObject();   
  } 
  ...
  */  
  public SpeakerFigure(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
