 ...
 * @generated */
public class CastMember extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(CastMember.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected CastMember() {/* intentionally empty block */}
   ...
   */
  public CastMember(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public CastMember(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
