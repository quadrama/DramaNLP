 ...
 * @generated */
public class SceneHeading extends Heading {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SceneHeading.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SceneHeading() {/* intentionally empty block */}
   ...
   */
  public SceneHeading(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public SceneHeading(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
