 ...
 * @generated */
public class SpeechProse extends Speech {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SpeechProse.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SpeechProse() {/* intentionally empty block */}
   ...
   */
  public SpeechProse(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public SpeechProse(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
