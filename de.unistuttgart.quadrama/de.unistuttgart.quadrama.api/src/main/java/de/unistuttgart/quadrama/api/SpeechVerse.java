 ...
 * @generated */
public class SpeechVerse extends Speech {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(SpeechVerse.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected SpeechVerse() {/* intentionally empty block */}
   ...
   */
  public SpeechVerse(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public SpeechVerse(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
