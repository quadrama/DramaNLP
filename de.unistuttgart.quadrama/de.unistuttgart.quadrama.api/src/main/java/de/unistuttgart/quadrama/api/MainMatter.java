 ...
 * @generated */
public class MainMatter extends Annotation {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(MainMatter.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected MainMatter() {/* intentionally empty block */}
   ...
   */
  public MainMatter(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public MainMatter(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
