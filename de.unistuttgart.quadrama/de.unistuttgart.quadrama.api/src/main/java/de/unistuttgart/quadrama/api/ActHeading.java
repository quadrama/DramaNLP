 ...
 * @generated */
public class ActHeading extends Heading {
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
  public final static int typeIndexID = JCasRegistry.register(ActHeading.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected ActHeading() {/* intentionally empty block */}
   ...
   */
  public ActHeading(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public ActHeading(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
