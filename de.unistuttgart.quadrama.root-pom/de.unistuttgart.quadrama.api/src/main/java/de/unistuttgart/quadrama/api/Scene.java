...
public class Scene extends Annotation {
  ...
  public final static int typeIndexID = JCasRegistry.register(Scene.class);
  /** @generated
   * @ordered 
   */
  @SuppressWarnings ("hiding")
   ...
   * @generated */
  protected Scene() {/* intentionally empty block */}
   ...
   */
  public Scene(int addr, TOP_Type type) {
    super(addr, type);
    readObject();
  }
  ...
  */  
  public Scene(JCas jcas, int begin, int end) {
    super(jcas);
    setBegin(begin);
    setEnd(end);
    readObject();
